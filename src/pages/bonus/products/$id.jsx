...
import { getProductsByCategoryId, getUserData } from "../../../api";
...
function Products() {
  ...
  useEffect(() => {
    async function fetch() {
      await getUserData(tg?.initDataUnsafe?.user?.id)
        .then((data) => {
          setUser(data);
        })
        .catch((error) => {
  ...
  return (
    <>
      <div className="">
        <div className="header flex justify-between items-center px-5 py-5 bg-blue-500 text-white shadow-xl">
          <Link to="/bonus">
            <svg
              width="25px"
              height="25px"
          ...
          <div className="flex items-center">
            <h3 className="mr-2">Keshbek:</h3>{" "}
            <h3>{formatCurrency(user?.bonus)}</h3>
          </div>
                ...
                <div className="text-center">
                  ...
                  {!inCard(item?.id) ? (
                    ...
                    <div className="flex justify-center items-center mt-2">
                      ...
                      <span className="px-5">{productQuantity(item?.id)}</span>
